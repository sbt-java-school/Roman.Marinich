...
import main.java.sbt.HomeTasks.ThreadPool.InnerThread;
...
public class Task2 implements ExecutionManager {
    ...
    private class ContextImpl implements Context {
        private ArrayList<InnerThread> threads;

        public ContextImpl(ArrayList<InnerThread> threads) {
    ...
    public Context execute(Runnable callback, Runnable... tasks) {
        ...
        ArrayList<InnerThread> workedThreads = new ArrayList<>(tasks.length);
